...
void _inorderTraversal(ostream& output, NODE* cur) const
  ...
  {         
		...
		//cout << " (NODE* Parent, NODE* N)" << Parent << " " << N->Key << endl;
...
// 		cout << "......out Right Rotation........................................... "<< endl<< endl << endl <<endl;
  ...
  {
    //Nodes for each leaves of the tree
    //
//      NODE* R = N->Right;
//      NODE* B = R->Left; 
// 	 NODE* A = N->Left;
...
// 	  cout << " Start Left Rotation " << endl;
// 	  cout << " N->Key = "  << N->Key << endl;
// 	  cout << " N->Left->Key = "  << N->Left->Key << endl;
// 	  cout << " N->Left->Left->Key = "  << N->Left->Left->Key << endl;
//    cout << " end of Left Rotation " << endl;
...
//	R->isThreaded = false;     //R is always traded 

	//cout << " Inside Left Rotation " << endl;
    if(Parent == NULL)
	    {
		   Root = R;
...
// 	  cout << " R->Key= "  << R->Key << endl;
// 	  cout << " R->Left->Key= "  << R->Left->Key << endl;
// 	  cout << " R->Right->Key= "  << R->Right->Key << endl;
...
// 				  cout << " ----------------------------------------------------" << endl;
// 				  cout << " else hLL < hLR "<< endl;
// 				 // cout << " Parent = " << Parent->Key << endl;
// 				  cout << " N->Key = " << N->Key << endl;
// 				  cout << " N->Left =" << N->Left->Key << endl;
// 				  cout << " N->Left->Right =" << N->Left->Right->Key << endl;
// 				  cout << " ----------------------------------------------------" << endl << endl;
				  
				 _LeftRotate(N, N->Left);
				 
// 				 cout << " In rotate to fix = " << endl; ///<< Parent->Key << endl;
// 				 cout << " N->Key = " << N->Key << endl;
// 				  cout << " N->Left->Key = " << endl;// << N->Left->Key << endl;
				 _RightRotate(Parent, N);
			   }
...
////////////////////////////////////////////////////
  ...
  if (cur == NULL ){  
		if ( prev->Key > lower ||  prev->Key < lower  )   //condition if lower found in tree set is pointer on the lower
		   Begin = prev;
